...
## Preconditions
- [x] V1 regression suite green (`pytest` — 16 passed)
...
- [x] `/health` responds (ST10) and `/v2/compare` returns an impact summary (ST12)

## Scale
- [x] Comparison completes within the time budget on a larger portfolio (ST16)

## Exit criteria for `v2.0`
- [x] Checklist executed with pass/fail evidence (`docs/V2_SYSTEM_TEST_EVIDENCE.md` — **16/16 PASS**)
